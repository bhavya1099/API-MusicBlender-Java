...
Test generated for /api/customer/merchants_get for http method type GET in rest-assured framework

RoostTestHash=f76cd8bf0a
...
public class merchantsGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/medeiros/RoostTest/merchantsGetTest.csv");
    }

  
    @Test  
    public void merchantsGet_Test() {
        this.setUp();
