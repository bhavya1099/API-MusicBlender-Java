...
public class restaurantTableGroupGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.loadData("src/test/java/com/medeiros/RoostTest/restaurantTableGroupGetTest.csv");
    }

  
    @Test  
    public void restaurantTableGroupGet_Test() {
        this.setUp();
        for (Map<String, String> map : envList) {
          RestAssured.baseURI = map.get("BASE_URL");  
                ...
                if (response.statusCode() == 200) {
					System.out.println("Description: Get Customer Restaurant Table Groups");
				}
